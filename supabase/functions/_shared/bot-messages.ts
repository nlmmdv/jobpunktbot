...
/** Постоянное меню — reply_keyboard при /start */
export const mainMenu = () => ({
  keyboard: [
    [{ text: "📋 Биржа смен", web_app: { url: MINI_APP_URL } }],
    [{ text: "💬 Обратная связь" }, { text: "ℹ️ О сервисе" }],
  ],
...
Есть вопросы? Нажми <b>💬 Обратная связь</b> — всегда готов помочь.`,
...
Как прошла смена?`,
  ...
  /** О сервисе */
  about: () =>
    `ℹ️ <b>ПроПункт — биржа труда для ПВЗ</b>

🔍 Ищите подработку или постоянную работу на пунктах выдачи WB, Ozon, Яндекс Маркет.

👔 Владельцы ПВЗ — находите сотрудников быстро и удобно.

<b>Что вас ждёт:</b>
⭐ Рейтинг и отзывы
🔔 Уведомления о сменах
📍 Поиск по метро и городу

Есть вопросы? Нажмите <b>💬 Обратная связь</b>`,
};
